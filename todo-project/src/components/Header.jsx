...
function Header() {
  return (
    <div className='flex justify-between md:w-[955px] m-5 text-gray'>
        ...
        <div className='flex items-center'>
            ...
            <div className='mx-5 cursor-pointer'><img src={profilbild} alt="profilbild" width="44.07px" height="44px" className='rounded-full'/></div>
